...
struct InterruptDescriptor{
  // offset_[low|middle|high] compose of the addr of the handler. They are split into three due to historical reason.
  uint16_t offset_low;
  // recent OSs doesn't use segmentation, hense x86-64 reduced its segment functionality. It is used just to specify perimssion of whole memory.
